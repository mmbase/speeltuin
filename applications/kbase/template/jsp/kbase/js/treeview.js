...
// ---------------------------------------------------------------------------
//globale variabel voor de huidige node.
//toegevoegd door Ernst Bunders op 2-1-2004
var currentFolder=null;
var IMGDIR="img/";
var FOLDERIMAGE="folder.gif";
var CURRENTFOLDERIMAGE="currentFolder.gif";
/*****************************************************************************
Name : toggle
...
function toggle2(node, folderCode) {
  ...
  toggle(node);
  //selectFolder(folderCode); veranderd door ernst bunders op 5-1-2003
  //het komt mij beter uit om de node in de callback functie te krijgen
  selectFolder(node);
}
...
/*****************************************************************************
Name : getImageNode
Parameters : Node folder. 
Return : node of 'img' element. This is the SECOND image under the 'folder' node
Author : Ernst Bunders;
*****************************************************************************/

function getImageNode(folder) {
  
  var imgNode=folder;
  var slip=1;
    while(imgNode.nodeName!="IMG" ){
      imgNode=imgNode.firstChild;
      //let the first one slip
      if(imgNode.nodeName=="IMG" && slip==1){
        slip=0;
